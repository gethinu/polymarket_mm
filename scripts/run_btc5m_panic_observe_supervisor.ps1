param(
  ...
  [string]$ConfigFile = "configs/bot_supervisor.btc5m_panic.observe.json",
  [string]$LogFile = "logs/btc5m_panic_supervisor.log",
  [string]$StateFile = "logs/btc5m_panic_supervisor_state.json",
  [string]$LockFile = "logs/btc5m_panic_observe_supervisor.lock",
  [double]$PollSec = 1,
